        ...
        <div class="md-card">
            <div class="user_heading">
                ...
                <div class="user_heading_content" style="display:table;margin:0 auto;">
                    <h2 style="margin: 10px;" class="heading_b uk-margin-bottom"><span class="uk-text-break">{{$herbal_center->b_herbal_center_name}}</span>
                    </h2>
                </div>
            </div>
                            ...
                            <div class="uk-width-large-1-1">
                                ...
                                <ul class="md-list md-list-addon">
                                    ...
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            <span style="margin-top:5px" class="md-list-heading">
                                                <a href = "mailto:{{$herbal_center->herbal_center_email_ad}}">{{$herbal_center->herbal_center_email_ad}}</a>
                                            </span>
    ...
    @else
        ...
        <div class="md-card">
            <div class="user_heading">
                ...
                <div class="user_heading_content" style="display:table;margin:0 auto;">
                    <h2 style="margin: 10px;" class="heading_b uk-margin-bottom"><span class="uk-text-break">{{$herbal_center->herbal_center_name}}</span>
                    </h2>
                </div>
            </div>
