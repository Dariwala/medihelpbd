            ...
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b uk-margin-bottom"><span style="margin : 10px;" class="uk-text-break">{{$air_ambulance->b_air_ambulance_name}}</span>
                        </h2>
                    </div>
                </div>
        ...
        <div class="md-card">
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b uk-margin-bottom"><span style="margin: 10px;" class="uk-text-break">{{ $air_ambulance->air_ambulance_name }}</span>
                        </h2>
                    </div>
                </div>
