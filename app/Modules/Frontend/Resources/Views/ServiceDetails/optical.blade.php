            ...
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b uk-margin-bottom"><span style="margin: 10px;" class="uk-text-break">{{$optical->b_optical_name}}</span>
                        </h2>
                    </div>
                </div>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading">
                                                    <a href = "mailto:{{$optical->optical_email_ad}}">{{$optical->optical_email_ad}}</a>
                                                </span>
        ...
        <div class="uk-width-large-7-10">
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b uk-margin-bottom"><span style="margin: 10px;" class="uk-text-break">{{$optical->optical_name}}</span>
                        </h2>
                    </div>
                </div>
                                ...
                                <div class="uk-width-large-1-1">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        ...
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                <span style="margin-top:5px" class="md-list-heading"><a href = "mailto:{{$optical->optical_email_ad}}">{{$optical->optical_email_ad}}</a></span>
