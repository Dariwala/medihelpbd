            ...
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b uk-margin-bottom"><span class="uk-text-break">{{$homeopathic->b_homeopathic_name}}</span>
                        </h2>
                    </div>
                </div>
        ...
        <div class="uk-width-large-7-10">
            <div class="md-card">
                <div class="user_heading">
                    ...
                    <div class="user_heading_content" style="display:table;margin:0 auto;">
                        <h2 class="heading_b uk-margin-bottom"><span class="uk-text-break">{{$homeopathic->homeopathic_name}}</span>
                        </h2>
                    </div>
                </div>
