        ...
        <div class="md-card">
            <div class="user_heading">
                ...
                <div class="user_heading_content" style="display:table;margin:0 auto;">
                    <h2 class="heading_b uk-margin-bottom"><span class="uk-text-break">{{$blood_bank->b_blood_bank_name}}</span>
                    </h2>
                </div>
            </div>
    ...
    @else
        ...
        <div class="md-card">
            <div class="user_heading">
                ...
                <div class="user_heading_content" style="display:table;margin:0 auto;">
                    <h2 class="heading_b uk-margin-bottom"><span class="uk-text-break">{{$blood_bank->blood_bank_name}}</span>
                    </h2>
                </div>
            </div>
